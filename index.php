...
// $str1 = 'football';
// $str2 = 'footboll';
// $str_position = strspn($str1 , $str2);
// echo "First difference between two strings at position $str_position: '$str1[$str_position]' vs '$str2[$str_position]'"
?>
...
//   echo join(' ', str_split($replaced_string));
?>
